...
<div class="agile-grids">
    <div class="grids">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">{!! lang('category.category') !!} Listing <a class="btn btn-sm btn-primary pull-right" href="{!! route('category.create') !!}"> <i class="fa fa-plus fa-fw"></i> {!! lang('common.create_heading', lang('category.category')) !!} </a><a style="margin-right: 10px;" href="{{ url()->previous() }}" class="btn btn-sm btn-success pull-right">Back</a></h1>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            ...
                                            'route' => array('category.paginate'), 'id' => 'ajaxForm')) !!}
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        {!! Form::label('group_id', lang('group.group'), array('class' => 'control-label')) !!}
                                                        {!! Form::select('group_id', $groups, (session('group_id') != "") ? session('group_id') : '', array('class' => 'form-control')) !!}
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-sm-3 margintop20">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="{!! route('category.index') !!}" class="btn btn-success"> {!! lang('common.reset_filter') !!}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            {!! Form::close() !!}
