...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-10">
                <h1 class="page-header">{!! lang('faq.faq') !!} <a style="margin-right: 10px;" href="{{ url()->previous() }}" class="btn btn-sm btn-success pull-right">Back</a></h1>
                ...
                <div class="panel panel-widget forms-panel">
                    <div class="forms">
                        <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                @if($route == 'faq_section_create')
                                    {!! Form::open(array('method' => 'POST', 'route' => array('faq_section_post'), 'id' => 'faq-form', 'class' => '', 'files' => 'true')) !!}
                                @else
                                    Nothing
                                @endif
