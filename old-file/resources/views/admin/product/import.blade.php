                    ...
                    <div class="forms">
                        <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                            <div class="form-title">
                                <h4>{!! lang('user.upload_file') !!} <a href="{{ asset('uploads/product_import_sample/product-sample.docx') }}" class="pull-right">&nbsp Download Sample</a><a class="pull-right" href="{{ route('level_export') }}">Download Levels | </a></h4>
                            </div>
                            <div class="form-body">
