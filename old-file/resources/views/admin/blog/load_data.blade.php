...
<tr id="order_{{ $detail->id }}">
    ...
    <td>
        <a href="{!! route('blog.edit', [$detail->id]) !!}">
            {!! $detail->name !!}
        </a>
    </td>
    ...
    <td class="text-center col-md-1">
        <a class="btn btn-xs btn-primary" href="{{ route('blog.edit', [$detail->id]) }}"><i class="fa fa-edit"></i></a>

        <!-- <a title="{!! lang('common.delete') !!}" class="btn btn-xs btn-danger __drop" data-route="{!! route('blog.drop', [$detail->id]) !!}" data-message="{!! lang('messages.sure_delete', string_manip(lang('blog.blog'))) !!}" href="javascript:void(0)">
