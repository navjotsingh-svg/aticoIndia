...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">{!! lang('sub_category.sub_category') !!} Listing <a class="btn btn-sm btn-primary pull-right" href="{!! route('sub_category.create') !!}"> <i class="fa fa-plus fa-fw"></i> {!! lang('common.create_heading', lang('sub_category.sub_category')) !!} </a><a style="margin-right: 10px;" href="{{ url()->previous() }}" class="btn btn-sm btn-success pull-right">Back</a></h1>
                      ...
                      <h3>Sub Category Details</h3>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            ...
                                            'route' => array('sub_category.paginate'), 'id' => 'ajaxForm')) !!}
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 margintop20">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="{!! route('sub_category.index') !!}" class="btn btn-success"> {!! lang('common.reset_filter') !!}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            {!! Form::close() !!}
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="col-md-3 padding0 marginbottom10">
                                ...
                                <!-- {!! Form::text('name', null, array('class' => 'form-control live-search', 'placeholder' => 'Search sub_category by name')) !!} -->
                            </div>
