            ...
            <div style="padding: 0px 10px;">
              <table style="color: #fff; width: 100%;" cellpadding="0" cellspacing="0">
                <tbody style="font-weight: 600;">
                  ...
                  <tr style="text-transform: capitalize;">
                    <td style="background-color: #f76b2b; border: 1px solid #e1e1e1; padding: 6px 3px; font-size: 14px;">Page URL</td>
                    <td style="border: 1px solid #e1e1e1; padding: 6px 3px; font-size: 14px;">{{ $page_url }}</td>

                  </tr>
                  <tr style="text-transform: capitalize;">
                    <td style="background-color: #f76b2b; border: 1px solid #e1e1e1; padding: 6px 3px; font-size: 14px;">Applicant's IP</td>
                    <td style="border: 1px solid #e1e1e1; padding: 6px 3px; font-size: 14px;">{{ $ip_address }}</td>
                  ...
                  <tr style="text-transform: capitalize;">
                    ...
                    <td style="border: 1px solid #e1e1e1; padding: 6px 3px; font-size: 14px;">
                      <a style="color:#fff;text-decoration: none;" href="https://www.aticoindia.com/public<?= $file_name ?>" target="_blank">View Document</a></td>
                  </tr> 
                  @endif
                </tbody>
              </table>
