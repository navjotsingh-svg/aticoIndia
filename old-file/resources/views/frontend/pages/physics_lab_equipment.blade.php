                                ...
                                <div class="ts-vc_cta3-content">
                                  <div class="ts-vc_cta3-content-header ts-wrap">
                                    <div class="ts-vc_cta3-headers ts-wrap-cell">
                                      <h2 class="ts-custom-heading libre-baskerville-bold" >Physics Lab Equipment <br> Manufacturer in Mumbai</h2>
                                    </div>
                                  </div>
                                 
                                  <div class="ts-cta3-content-wrapper">
                                    <p>Atico India is your premier destination for high-quality physics lab equipment in Mumbai. We understand the intricate demands of physics education and research, and our commitment to excellence drives us to provide comprehensive solutions that foster scientific exploration.
...
<div class="container-fluid all_products">
 ...
 @if($display==1) <h2 class="ts-custom-heading libre-baskerville-bold" style="color:#fff;text-align: unset;padding-top: 90px;line-height: initial;padding-left: 4%;margin-top: 0 !important;">Leading Physics Lab Instruments Manufacturer in Mumbai</h2>
  ...
  <div class="product">
    ...
    <img src="{{ asset('uploads/product_images/Push-Bell.jpg') }}" width="280" height="250">
    <p>Bell Push</p>
    </a>
  </div>
  <div class="product2">
    ...
    <img src="{{ asset('uploads/product_images/914643Dynamo%20Bicycle.jpg') }}" width="280" height="250">
    <p> Dynamo Bicycle</p>
    </a>
  </div>
  <div class="product3">
    ...
    <img src="{{ asset('uploads/product_images/668046Kelvin%20Bridge.gif') }}" width="280" height="250">
    <p>Kelvin Bridge</p>
    </a>
  </div>
  <div class="product4">
...
<div class="product5">
    ...
    <img src="{{ asset('uploads/product_images/304894Morse Sounder.jpg') }}" width="280" height="250">
    <p>Morse Sounder</p>
    </a>
  </div>
  <div class="product6">
    ...
    <img src="{{ asset('uploads/product_images/Porous-Pot-1.jpg') }}" width="280" height="250">
    <p>Porous Pot</p>
    </a>
  </div>
  <div class="product7">
    ...
    <img src="{{ asset('uploads/product_images/resistance-coil.jpg') }}" width="280" height="250">
    <p>Resistance Coil</p>
    </a>
  </div>
  <div class="product8">
   ...
   <img src="{{ asset('uploads/product_images/Rheostat-Single-Tube.jpg') }}" width="280" height="250">
    <p>Rheostat</p>
    </a>
  </div>
</div>
  ...
  @else
 <h2 class="ts-custom-heading libre-baskerville-bold" style="color:#fff;text-align: center;padding-top: 15px;line-height: initial;padding-left: 20px;">Leading Physics Lab Instruments Manufacturer in Mumbai</h2>
  <div class="product">
    <a href="/product/bell-push">
    <img src="{{ asset('uploads/product_images/Push-Bell.jpg') }}" width="150" height="150">
    <p>Bell Push</p>
</a>
  </div>
  <div class="product2">
     <a href="/product/dynamo-bicycle">
    <img src="{{ asset('uploads/product_images/914643Dynamo%20Bicycle.jpg') }}" width="150" height="150">
    <p> Dynamo Bicycle</p>
</a>
  </div>
  <div class="product3">
    ...
    <img src="{{ asset('uploads/product_images/668046Kelvin%20Bridge.gif') }}" width="150" height="150">
    <p>Kelvin Bridge</p>
</a>
  </div>
  <div class="product4">
    ...
    <img src="{{ asset('uploads/product_images/311434Morse%20Key.png') }}" width="150" height="150">
    <p>Morse Key</p>
</a>
  </div>
  ...
  <div class="product5">
    ...
    <img src="{{ asset('uploads/product_images/304894Morse Sounder.jpg') }}" width="150" height="150">
    <p>Morse Sounder</p>
</a>
  </div>
  <div class="product6">
    ...
    <img src="{{ asset('uploads/product_images/Porous-Pot-1.jpg') }}" width="150" height="150">
    <p>Porous Pot</p>
</a>
  </div>
  <div class="product7">
    ...
    <img src="{{ asset('uploads/product_images/resistance-coil.jpg') }}" width="150" height="150">
    <p>Resistance Coil</p>
</a>
  </div>
  <div class="product8">
   ...
   <img src="{{ asset('uploads/product_images/Rheostat-Single-Tube.jpg') }}" width="150" height="150">
    <p>Rheostat</p>
</a>
  </div>
                            ...
                            <div class="ts-vc_general ts-vc_cta3 ts-cta3-only ts-vc_cta3-style-classic ts-vc_cta3-shape-rounded ts-vc_cta3-align-left ts-vc_cta3-color-transparent ts-vc_cta3-icon-size-md ts-vc_cta3-actions-no ts-cta3-with-desc">
                              <div class="ts-vc_cta3_content-container">
                                <div class="ts-vc_cta3-content">
                                  <div class="ts-vc_cta3-content-header ts-wrap">
                                    <div class="ts-vc_cta3-headers ts-wrap-cell">
                                      <h2 class="ts-custom-heading libre-baskerville-bold" >Factors That Make Atico India The Top Physics Lab Equipment Manufacturer in Mumbai</h2>
                                    </div>
                                  </div>
                                  @if($display==1)
                                  <div class="ts-cta3-content-wrapper boxes">
                                    <div class="box ">
                                      ...
                                      <h3>Extensive Range of Physics Apparatus</h3>
                                      <p>Our comprehensive catalog caters to the diverse needs of physics laboratories, whether you are a school aiming to inspire budding scientists, an academic institution conducting groundbreaking research, or a company pushing the boundaries of technological innovation. Physics Lab Equipment Supplier in Mumbai offers a wide variety of instruments to support all facets of physics exploration.
                                      </p>
                                    </div>
                                  ...
                                  <div class="ts-cta3-content-wrapper boxes">
                                    <div class="box ">
                                      ...
                                      <h3>Local Presence, Global Reach</h3>
                                      <p>While the top Physics Lab Equipment Supplier in Mumbai is headquartered in Ambala, Haryana, our reach extends across India and beyond. Our efficient logistics network ensures timely delivery of all types of physics lab equipment, no matter where your lab is located.
                                      </p>
                                    </div>
                                    ...
                                    <div class="box ">
                                      ...
                                      <p>We strongly believe in competitive pricing for good physics laboratory equipment. It provides transparent and competitive prices that foster scientific learning and investigation and are accessible at all institutions.
                                      </p>
                                    </div>
                                    ...
                                    <div class="box ">
                                      ...
                                      <p>Our team of highly skilled professionals, who understand and appreciate subject matter, helps us anticipate our customers' needs. This enables us to offer an equipment range that facilitates meaningful and effective learning and research experiences.
                                      </p>
                                    </div>
...
<div class="ts-row wpb_row vc_row-fluid vc_custom_1535112868661 ts-responsive-custom-32388294 ts-break-col-991 ts-total-col-2 ts-zindex-0 vc_row container ts-bgimage-position-center_center  lab-tenders">
                <div class="vc_row-o-equal-height vc_row-flex">
                            ...
                            <div class="ts-vc_general ts-vc_cta3 ts-cta3-only ts-vc_cta3-style-classic ts-vc_cta3-shape-rounded ts-vc_cta3-align-left ts-vc_cta3-color-transparent ts-vc_cta3-icon-size-md ts-vc_cta3-actions-no ts-cta3-with-desc">
                              <div class="ts-vc_cta3_content-container">
                                <div class="ts-vc_cta3-content">
                                  <div class="ts-vc_cta3-content-header ts-wrap">
                                    <div class="ts-vc_cta3-headers ts-wrap-cell">
                                      <h2 class="ts-custom-heading libre-baskerville-bold in-touch"  >Get in Touch </h2>
                                    </div>
                                  </div>
                                  @if($display==0)
                  <div class="ts-column wpb_column vc_column_container vc_col-sm-5 vc_col-has-fill ts-zindex-0 ts-span ts-right-span">
                  ...
                  @endif
                                  <div class="ts-cta3-content-wrapper">
                                    <p>Get started on your next physics adventure with Atico India. Give us a call and talk about your lab equipment requirements so we can work together on building one of the best-in-class physics laboratories that encourage self-learning.
                                    <br>
