    ...
    <div class="row hero-row">
      ...
      <div class="col-md-12 hero-left">
        <div class="hero-left-inner">
          <h1 class="hero-head">Scientific Laboratory Glassware Supplier <br>in Vietnam</h1>

          <p class="hero-lead">
           As a trusted scientific laboratory glassware supplier in Vietnam, Atico India offers high-precision, durable, and chemically stable laboratory glassware to schools, universities, research centers, and industrial laboratories. 
          </p>
        ...
        <div class="row">
          ...
          <div class="col-md-4 threebox-col">
            <div class="threebox-inner">
              ...
              <div class="threebox-content">
                <h4 class="threebox-title">Trusted Glassware Range
</h4>
                <p class="threebox-desc">Our glassware is crafted from high-grade borosilicate glass, ensuring clarity, chemical resistance, and long-lasting performance.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 threebox-col threebox-mid">
            <div class="threebox-inner">
              ...
              <div class="threebox-content">
                <h4 class="threebox-title">Ensured Consistency in Results</h4>
                <p class="threebox-desc">We employ automated methods of shaping, fire polishing, and precision calibration so that each experiment yields consistent results.
</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4 threebox-col">
            <div class="threebox-inner">
              ...
              <div class="threebox-content">
                <h4 class="threebox-title">Global Footprint</h4>
                <p class="threebox-desc">Atico India exports and supplies scientific glassware worldwide, ensuring a strong international presence and timely delivery to Vietnam.</p>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-md-12">
        ...
        <h6 class="pr-title">Our Scientific Laboratory Glassware Product Range</h6>
        <p class="pr-sub">Our most in-demand laboratory equipment in Vietnam includes volumetric flasks, conical flasks, beakers, burettes, and measuring cylinders, wherein durability, precision, and good transparency are key issues. 
</p>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6 about-right">
        <div class="about-right-inner">
          ...
          <h2 class="about-title">Leading Manufacturer & Supplier for Laboratory Glassware in Vietnam</h2>

          <div class="about-paragraphs">
            <p>As a rapidly growing scientific partner in Southeast Asia, Atico India takes pride in being a reliable scientific laboratory glassware manufacturer in Vietnam and a trusted laboratory glassware supplier in Vietnam. We understand the laboratory culture of Vietnam, where industries such as pharmaceuticals, food testing, chemical production, and environmental research require precision-built glassware.   </p>
          ...
          <div class="row about-bullets">
            <div class="col-md-6 bullet-col">
              <div class="bullet">
                ...
                <div class="bullet-text mtext">Products to meet the requirements of global and Vietnamese laboratories</div>
              </div>
              ...
              <div class="bullet">
                ...
                <div class="bullet-text">Strong packaging solutions for safe and undamaged delivery within Vietnam.
</div>
              </div>
            </div>
            ...
            <div class="col-md-6 bullet-col">
              <div class="bullet">
                ...
                <div class="bullet-text mtext">Easy availability in bulk quantities of basic laboratory glassware</div>
              </div>
              ...
              <div class="bullet">
                ...
                <div class="bullet-text">A name trusted by research labs, universities, and testing facilities in industry.</div>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 cta-left">
        ...
        <p class="cta-sub">
          Atico India is the leading laboratory glassware manufacturer in Vietnam. To enhance the efficiency and productivity of laboratories, we offer tailored solutions. Contact us today to know more. 
        </p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 vp-left">
                ...
                <h2 class="vp-title">
                   High-Quality Laboratory Glassware for Use Within Scientific and Industrial Applications in Vietnam
                </h2>

                <p class="vp-text">
                   The glassware in Vietnam needs to respond to both routine applications and highly advanced chemical testing. Atico India manufactures this type of glassware with high precision, strong durability, and international-grade safety. Our products support consistent measurement, chemical purity, and reliable outcomes; hence, they are ideal for the growing educational and industrial ecosystem in Vietnam.
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 vp-box-col">
                        <div class="vp-box">
                            ...
                            <p class="vp-box-text">Premium borosilicate construction for clarity and chemical resistance</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 vp-box-col">
                        <div class="vp-box">
                            ...
                            <p class="vp-box-text">Heat-resistant design, suitable for numerous applications in the laboratory.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 vp-box-col">
                        <div class="vp-box">
                            ...
                            <p class="vp-box-text">Accurately graduated to provide dependable measurement.
</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 vp-box-col">
                        <div class="vp-box">
                            ...
                            <p class="vp-box-text">It carries a wide range of products intended for a variety of research and testing applications.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="faq-box">
                    <div class="faq-header active">
                        ...
                        Does Atico India supply its lab glassware throughout Vietnam?


                    </div>
                    <div class="faq-body" style="display:block;">
                        Yes. We are the leading scientific laboratory glassware supplier and supply glassware across major cities in Vietnam, including industrial zones, using fast and secure logistics.
                ...
                <div class="faq-box">
                    <div class="faq-header">
                        ...
                        Why do Laboratories trust scientific laboratory glassware from Atico India in Vietnam?
                    </div>
                    <div class="faq-body">
                       We use high-quality borosilicate glass for glassware production. Latest manufacturing technology ensures the highest international quality standards. 
                 ...
                 <div class="faq-box">
                    <div class="faq-header">
                        <span class="faq-icon">+</span>
                       Do you supply your laboratory glassware in bulk quantities to universities and industry labs? 

                    </div>
                    <div class="faq-body">
                        Yes, definitely, as we accept bulk orders originating from educational institutions, chemical industries, medical laboratories, and research centers all over Vietnam. 
            ...
            <div class="col-md-6">
                ...
                <div class="faq-box">
                    <div class="faq-header">
                        <span class="faq-icon">+</span>
                        What type of Laboratory Glassware does Atico India supply to laboratories in Vietnam? 


                    </div>
                    <div class="faq-body">
                        Our glassware range is vast. We offer tailored solutions for every piece of glassware. 
                ...
                <div class="faq-box">
                    <div class="faq-header">
                        <span class="faq-icon">+</span>
                        How does Atico India ensure safe glassware delivery to Vietnam? 


                    </div>
                    <div class="faq-body">
                        Every item is packed with export-grade cushioning, shock-proof layering, and strong cartons to prevent breakage. 
                    </div>
                </div>
...
<input type="hidden" name="page_url" value=<?=  (empty($_SERVER['HTTPS']) ? 'http' : 'https') . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?> >
      ...
      <div class="col-md-6">
        <div class="connect-image-wrap">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59583.7426689033!2d105.7797882158134!3d21.03332952131903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac7c33fd6323%3A0x930d205cf25ff492!2sHanoi%20Medical%20University!5e0!3m2!1sen!2sin!4v1765371444770!5m2!1sen!2sin" width="600" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
